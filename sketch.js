...
function setup(){
    ...
    ground2 = new Ground(400, 480, 400, 20);
    ground3 = new Ground(800,200,200,20);
    
    block1=new Blueblock(265,448,60,40);
    block2=new Blueblock(320,448,60,40);
    block3=new Blueblock(380,448,60,40);
    block4=new Blueblock(435,448,60,40);
    block5=new Blueblock(500,448,60,40);
    block6=new Block(290,425,60,40);
    block7=new Block(350,425,60,40);
    block8=new Block(410,425,60,40);
    block9=new Block(470,425,60,40);
